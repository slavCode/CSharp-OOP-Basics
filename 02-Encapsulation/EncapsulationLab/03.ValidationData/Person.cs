...
public class Person
{
    ...
    public double Salary
    {
        ...
        set
        {
            if (value < 460) throw new ArgumentException("Salary cannot be less then 460 leva");
    ...
    {
        if (this.age > 30) this.salary += this.salary * percent / 100;

        else this.salary += this.salary * percent / 200;
    }
}
